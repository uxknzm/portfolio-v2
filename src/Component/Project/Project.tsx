...
const Project = () => {
    return (
        <div className={s.projects_section}>
            <div className={s.wrapper__projects_grid}>
                <div className={s.normal_wrapper}>
                    ...
                    {projectLeft.map(p => <motion.a whileHover={{ scale: 1.03 }} key={p.id} href={p.link} className={s.project_wrapper__24px_bottom_m__w_inline_block}>
                ...
                <div className={s.normal_wrapper}>
                    {projectRight.map(pr => <motion.a whileHover={{ scale: 1.03 }} key={pr.id} href={pr.link} className={s.project_wrapper__24px_bottom_m__w_inline_block}>
