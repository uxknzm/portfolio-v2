    ...
    return (
        <footer className={s.footer}>
            <div className={s.wrapper__footer_grid}>
                ...
                <div className={s.normal_wrapper__flex_horizontal_left_top}>
                    <a href="#" className={s.footer_link_block__w_inline_block}>
                        <div className={s.footer_link}>Home</div>
                        <div className={s.footer_link}>About</div>
                        <div className={s.footer_link}>Work</div>
                        <div className={s.footer_link}>Process</div>
                    </a>
                    <a href="#" className={s.footer_link_block__w_inline_block}>
                        <div className={s.footer_link}>Store</div>
                        <div className={s.footer_link}>Blog</div>
                        <div className={s.footer_link}>Reading List</div>
                    </a>
                </div>
                <div>
